...
const CadastroFormFuncionario = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <input type="number" name="cargo" placeholder="Cargo" value={formData.telefone} onChange={handleChange} />
      <input type="number" name="salario" placeholder="Salário" value={formData.telefone} onChange={handleChange} />
